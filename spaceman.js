const mysteryWord = ['Atlanta Hawks', 'Boston Celtics', 'Brooklyn Nets', 'Charlotte Hornets', 'Chicago Bulls', 'Cleveland Cavaliers', 'Dallas Mavericks', 'Denver Nuggets', 
...
const wordChoice = [Math.floor(Math.random()*wordChoice.length)];
const message